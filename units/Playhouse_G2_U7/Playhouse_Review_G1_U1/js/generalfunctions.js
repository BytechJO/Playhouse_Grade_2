        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "underline_th_apostrophe":
              if (
                typeof underline_th_apostrophe_data !== "undefined" &&
                underline_th_apostrophe_data !== null
              ) {
                buildUnderlineThApostropheBody(underline_th_apostrophe_data);
              }
              break;
          }
        } else {
