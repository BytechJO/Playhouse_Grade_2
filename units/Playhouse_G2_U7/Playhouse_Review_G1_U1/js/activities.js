...
function initiateActivityType(aActTyp, aActSubType) {
  ...
  } else if (aActTyp == "underline_th_apostrophe") {
    theActivity = {
      orientationAdjust: "no",
      ...
      validate: function () {
        checkUnderlineThApostrophe(underline_th_apostrophe_data);
      },

      reset: function () {
        resetUnderlineThApostrophe();
