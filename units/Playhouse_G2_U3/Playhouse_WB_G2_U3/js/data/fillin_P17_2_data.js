var stereo_data = {
  ...
  "playListData" : [
      {
        'audiourl': '../audios/page_17/PLAYHOUSE_2_WB_UNIT_3_TRACK_07_01.mp3',
      },
      {
        'url': '',
      },
...
var fillin_data = {    
    ...
    "subTitleTextLeft"      : "<span class='blue_text'>2</span> Look and write each irregular singular or plural noun.",
    "subTitleTextRight"     : "",
    "subTitleIcons"         : [],
    ...
    "questions": [{
            ...
            "image": "../images/pages/activities/p17_2_1.png",
            "answer": ["men"],
        ...
        },
        {
            ...
            "audio": "../audios/under.mp3",
            "audioenable": "default", // correct (or) default
            "image": "../images/pages/activities/p17_2_2.png",
            "answer": ["child"],
            "strictcase": "no", // yes (or) no 
            "type": "text", // text (or) number
        },
        {
            ...
            "audio": "../audios/under.mp3",
            "audioenable": "default", // correct (or) default
            "image": "../images/pages/activities/p17_2_3.png",
            "answer": ["geese"],
            "strictcase": "no", // yes (or) no
            "type": "text", // text (or) number
        },
