        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "circleTheContractions":
              if (
                typeof contractions_story_data !== "undefined" &&
                contractions_story_data != null
              ) {
                buildCircleTheContractionsInTheStory(contractions_story_data);
              }
              break;
          }
        } else {
