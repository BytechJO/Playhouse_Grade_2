        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "sort_sentences_columns":
              if (
                typeof sort_sentences_columns_data !== "undefined" &&
                sort_sentences_columns_data !== null
              ) {
                buildSortSentencesColumnsBody(sort_sentences_columns_data);
              }
              break;
          }
        } else {
