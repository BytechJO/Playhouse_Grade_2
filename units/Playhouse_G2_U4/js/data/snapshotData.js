var snapshot_data = {
  "snapshot": [{
      "audio": ["../audios/page_32/pizza.mp3","../audios/page_32/dough.mp3","../audios/page_32/sauce.mp3","../audios/page_32/sprinkle.mp3","../audios/page_32/cheese.mp3","../audios/page_32/add.mp3","../audios/page_32/pepperoni.mp3","../audios/page_32/slice.mp3"],
...
var Popups_data = {
  "slides": [
    {
      'listen': {
        ...
        "words": ["1 aunt","2  uncle", "3 husband","4 wife","5 cousin", "6 nephew","7 son","8 daughter", "9 niece","10 neighbour"],
        "audio": ["../audios/page_32/1_aunt.mp3","../audios/page_32/2_uncle.mp3", "../audios/page_32/3_husband.mp3",
                  "../audios/page_32/4_wife.mp3", "../audios/page_32/5_cousin.mp3", "../audios/page_32/6_nephew.mp3",
                  "../audios/page_32/7_son.mp3", "../audios/page_32/8_daughter.mp3", "../audios/page_32/9_niece.mp3",
                  "../audios/page_32/10_neighbour.mp3"]},
      'listen2': {
        ...
        "titlesAudio" : ["../audios/page_32/Pg4_1.2_Adult_Lady.mp3"],
        "image": ["../images/pages/page-1/2-img-1.png","../images/pages/page-1/2-img-2.png"],
        "audio": ["../audios/page_32/Pg5_2.2_Adult Lady.mp3","../audios/page_32/Pg5_2.3_Adult Lady.mp3"]},
    },
  ],
  "class_name":["","","","","","","","","","","",""], //flex-row (or) flex-reverse (or) flex-column-reverse for each image-container **optional**
  "words"  : ["aunt","uncle", "husband","wife","cousin", "nephew","son","daughter", "niece","neighbour"],
 ...
 "postions"  : ["left:268px; top:227px;",
                "left:446px; top:235px;",
                "left:625px; top:235px;",
                "left:783px; top:235px;",
                "left:186px; top:412px;",
                "left:230px; top:564px;",//6
                "left:543px; top:399px;",
                "left:726px; top:431px;",//8
                "left:372px; top:491px;",
                "left:821px; top:636px;",
                // "left:508px; top:475px;",
                // "left:369px; top:569px;",
              ],
  "imagesAudio" :["../audios/page_32/1_aunt.mp3","../audios/page_32/2_uncle.mp3", "../audios/page_32/3_husband.mp3",
                  "../audios/page_32/4_wife.mp3", "../audios/page_32/5_cousin.mp3", "../audios/page_32/6_nephew.mp3",
                  "../audios/page_32/7_son.mp3", "../audios/page_32/8_daughter.mp3", "../audios/page_32/9_niece.mp3",
                  "../audios/page_32/10_neighbour.mp3"]
}