...
var Popups_data = {
  slides: [
    {
      listen: {
        ...
        titlesAudio: [
          "../audios/page_32/1_Listen_and_say.mp3",
        ...
        audio: [
          "../audios/page_32/1_aunt.mp3",
          "../audios/page_32/2_uncle.mp3",
          "../audios/page_32/3_husband.mp3",
          "../audios/page_32/4_wife.mp3",
          "../audios/page_32/5_cousin.mp3",
          "../audios/page_32/6_nephew.mp3",
          "../audios/page_32/7_son.mp3",
          "../audios/page_32/8_daughter.mp3",
          "../audios/page_32/9_niece.mp3",
  ...
  postions: [
  "left:26.93%; top:28.38%;",
  "left:34.82%; top:27.38%;",
  "left:46%; top:29.38%;",
  "left:54.91%; top:29.38%;",
  "left:22.61%; top:55.50%;",
  "left:24.54%; top:76.50%;", // 6
  "left:41.48%; top:54.88%;",
  "left:51.82%; top:58.88%;", // 8
  "left:31.21%; top:68.38%;",
  "left:59.30%; top:86.50%;",

  // "left:45.36%; top:59.38%;",
  // "left:32.95%; top:71.13%;",
],
  imagesAudio: [
    "../audios/page_32/1_aunt.mp3",
    "../audios/page_32/2_uncle.mp3",
