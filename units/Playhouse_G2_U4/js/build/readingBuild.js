    ...
    for (var slideIndex = 0; slideIndex < aObj.slides.length; slideIndex++) {
      ...
      if (slide.layout == "text_on_image") {
        ...
        if (slide.mainImage && slide.mainImage != "") {
          slideHtml +=
            "<img src='" + slide.mainImage + "' style='height: 500px;'/>";
        }
        ...
        cur_right_perc = 90;
        slideHtml +=
          "<div style='display: flex; flex-direction: column; align-items: center; padding: 20px; background-color: rgb(251,234,213); border-radius: 25px;'>";
        for (var stairIndex = 1; stairIndex <= 10; stairIndex++) {
          slideHtml +=
            "<div class='stair_top' style='top:" +
            50 +
            "px; left:" +
            50 +
            "px; width: " +
            ...
            "px; height: " +
            cur_height +
            "px; background: linear-gradient(0deg, rgba(255,255,255,1) 12%, rgba(219,219,219,1) 84%); clip-path: polygon(" +
            cur_left_perc.toFixed(2) +
            "% 0%, " +
            cur_right_perc.toFixed(2) +
            "% 0%, 100% 100%, 0% 100%);'>";
          slideHtml += "</div>";
          slideHtml +=
            "<div class='stair_front' style='top:" +
            100 +
            "px; left:" +
            50 +
            "px; width: " +
            cur_width +
            "px; height: 35px; background-color: #ccc;'>";
          slideHtml +=
            "<div class='snap_card mx-0 mx-md-auto audioIcon' data-slideNum='" +
            Number(slideIndex + 1) +
            "' data-audio='" +
            slide.audios[stairIndex - 1] +
            "'data-onaudioplay='color:#e43b6d'>";
          slideHtml +=
            "<p class='stair_text' style='width: 145px; font-weight: bold; font-size: 22px;'>" +
            slide.sentences[stairIndex - 1] +
            "</p>";
          slideHtml += "</div>";
          slideHtml += "</div>";
          cur_height += 2;
          ...
          // cur_left_perc -= 0.71;
          // cur_right_perc += 0.71;
          cur_left_perc -= Number(
            0.65 +
              ((10 - Math.abs(stairIndex - 5)) / 100) * 5 -
              stairIndex / 15,
          );
          cur_right_perc += Number(
            0.65 +
              ((10 - Math.abs(stairIndex - 5)) / 100) * 5 -
              stairIndex / 15,
          );
