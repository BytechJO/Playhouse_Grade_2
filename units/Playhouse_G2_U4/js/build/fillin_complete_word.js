...
var currentSentenceAudioUrl = "";

function playSentenceAudio(audioUrl) {
  if (!audioUrl) return;

  // إيقاف أي صوت شغال حاليًا
  ...
  currentSentenceAudioUrl = audioUrl;
...
// صوت جملة Sentences must have...
$(document).off("click", ".sentence_audio_box, .example_audio_sentence");

$(document).on(
  "click",
  ".sentence_audio_box, .example_audio_sentence",
  function (e) {
    e.preventDefault();
    e.stopPropagation();
