var _data = {
    ...
    "header": {
        ...
        "bgcolor": "linear-gradient(180deg, rgba(0,190,255,1) 0%, rgba(255,255,255,0) 100%)",
    ...
    "footer": {
        ...
        "bgcolor": "linear-gradient(0deg, rgba(0,190,255,1) 0%, rgba(255,255,255,0) 100%)",       
        "buttons"    : [],
        "filetoload" : [],
        "homebutton" : {
        ...
        "booksbutton" : {
            "workbook": {
                ...
                'link'      : '../../Playhouse_WB_G2/views/circle_word_in_sentence.html'
            },
            "studentbook": {
