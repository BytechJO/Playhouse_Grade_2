...
function initiateActivityType(aActTyp, aActSubType) {
  ...
  } else if (aActTyp == "oldwords") {
    theActivity = new OldWordsActivity(quePart[0], old_words_data);
  } else if (aActTyp == "doubleletter") {
    theActivity = new DoubleLetterWords(quePart, double_letter_data);
