      ...
      if (_fileType != "" && _fileBuild != "") {
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "oldwords":
              if (
                typeof old_words_data !== "undefined" &&
                old_words_data !== null
              ) {
                buildOldWordsBody(old_words_data);
              }
              break;
            case "doubleletter":
              if (
                typeof double_letter_data !== "undefined" &&
                double_letter_data !== null
              ) {
                buildDoubleLetterWordsBody(double_letter_data);
              }
              break;
