function buildMcqTickBody(aObj) {
    ...
    // ===================================================================== all_cont =====================
        if (layOut == 1) {
            ...
            htmlStmt += '<div class="all_cont d-flex flex-column justify-content-start justify-content-sm-center align-items-center">';
          
            htmlStmt += '<div class="tick_group d-flex flex-column" style="width:100%">'; 
