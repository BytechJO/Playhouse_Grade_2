function buildFillInBody(aObj) {
  ...
  if (aObj != undefined && aObj != null) {
    ...
    htmlStmt += '<div class="screen_elements d-flex">';
    
    htmlStmt += '<div class="group_elm d-flex flex-column justify-content-center">';
    ...
    for (x = 0; x < numOfQuestions; x++) {
      ...
      htmlStmt += '<img class="q_img image" src="'+tmpObj.image+'"/>';
