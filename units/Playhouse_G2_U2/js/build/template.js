...
function buildFooter(aObj) {
  ...
  if (
    ...
    fStmt +=
      '<div class="studentBookPagesToggle hamburgerBtn" id="studentBookPagesToggle">';
...
function buildStudentBookPagesSidebar() {
  ...
  var sStmt =
    '<div class="studentBookPagesSidebar" id="studentBookPagesSidebar">';
  sStmt += '<div class="studentBookPagesSidebarHeader">';
  sStmt += "<span>Student Book Pages</span>";
  sStmt +=
    '<span class="studentBookPagesSidebarClose" id="studentBookPagesSidebarClose">&times;</span>';
  sStmt += "</div>";
  ...
  sStmt += "</div></div>";
  sStmt +=
    '<div class="studentBookPagesSidebarOverlay" id="studentBookPagesSidebarOverlay"></div>';
