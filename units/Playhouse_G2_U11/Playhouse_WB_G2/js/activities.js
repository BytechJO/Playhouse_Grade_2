...
function initiateActivityType(aActTyp, aActSubType) {
  ...
  } else if (aActTyp == "match_clues_pictures_write_name") {
    theActivity = new MatchCluesPicturesWriteName(
      quePart,
      match_clues_pictures_write_name_data,
    );
  } else if (aActTyp == "look_write_prepositions") {
    theActivity = new LookWritePrepositions(
      quePart,
      look_write_prepositions_data,
    );
  } else if (aActTyp == "fill_letters_tick_picture") {
    theActivity = new FillLettersTickPicture(
      quePart,
      fill_letters_tick_picture_data,
    );
