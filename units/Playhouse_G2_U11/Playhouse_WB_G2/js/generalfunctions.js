        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "match_clues_pictures_write_name":
              if (
                typeof match_clues_pictures_write_name_data !== "undefined" &&
                match_clues_pictures_write_name_data != null
              ) {
                buildMatchCluesPicturesWriteNameBody(
                  match_clues_pictures_write_name_data,
                );
              }
              break;
            case "look_write_prepositions":
              if (
                typeof look_write_prepositions_data !== "undefined" &&
                look_write_prepositions_data !== null
              ) {
                buildLookWritePrepositionsBody(look_write_prepositions_data);
              }

              break;
            case "fill_letters_tick_picture":
              if (
                typeof fill_letters_tick_picture_data !== "undefined" &&
                fill_letters_tick_picture_data !== null
              ) {
                buildFillLettersTickPictureBody(fill_letters_tick_picture_data);
              }
