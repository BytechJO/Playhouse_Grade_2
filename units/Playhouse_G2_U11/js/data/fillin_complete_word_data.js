...
var fillin_data = {
  ...
  "subTitleTextLeft"      : "<span class='red_text'>3</span> &nbsp;  Write '<span class='red_text'>ea</span>' to complete the words. Then write the words.",
  "subTitleTextRight"     : "",
  ...
  "questions":
    ...
    "items":
        [
          ...
          "<span class='text'>"+
          "Prepositions come before the noun.<br>"+
          "<span class='red_text'>Preposition</span> +  <span class='red_text'>noun</span> <br>"+
          "The bee is <span class='red_text'>in</span> the <span class='red_text'>hive</span>. <br>"+
          "The bee is <span class='red_text'>on</span> this <span class='red_text'>flower</span>. <br>"+
          "The bee is <span class='red_text'>above</span> that <span class='red_text'>leaf</span>. <br>"+
          "</span>",
