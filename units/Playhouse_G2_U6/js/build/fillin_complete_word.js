...
$(document).off("click", ".middle_sentence_audio");

$(document).on("click", ".middle_sentence_audio", function (event) {
  event.preventDefault();
  event.stopPropagation();
...
$(document).off("click", ".image_sentence_audio");

$(document).on("click", ".image_sentence_audio", function (event) {
  event.preventDefault();
  event.stopPropagation();
