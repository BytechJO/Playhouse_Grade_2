function buildLineDrawBody(aObj) {
  ...
  if (aObj != undefined && aObj != null && aObj != {}) {
    ...
    htmlStmt +=
      '<div class="all_cont justify-content-start justify-content-lg-center">';

    var currentQue = 1;
    htmlStmt += '<div class="que options">';
    htmlStmt += '<div class="lines"></div>';
    htmlStmt +=
      '<div class="drag_wrap d-flex align-items-center justify-content-center"> <div class="dragger  d-flex ">';
    var onTextAudioPlay =
      typeof aObj.ontextaudioplay != undefined && aObj.ontextaudioplay != null
        ? aObj.ontextaudioplay
        : "color:red";
    var onImgAudioPlay =
      typeof aObj.onimgaudioplay != undefined && aObj.onimgaudioplay != null
        ? aObj.onimgaudioplay
    ...
    if (dragsArr.length > 0) {
      for (var dg = 0; dg < dragsArr.length; dg++) {
        ...
        htmlStmt +=
          '<div class="opt drag align-items-center" id="drag_' +
          currentQue +
          "_" +
          (dg + 1) +
          '">';
        ...
        if (
          dragsArr[dg].text != "" &&
          dragsArr[dg].text != "no" &&
          dragsArr[dg].image == "no"
        ) {
          htmlStmt +=
            '<div class="txtHolder audioTile" data-audio="' +
            dragsArr[dg].audio +
            '" data-onaudioplay="' +
            onTextAudioPlay +
            '">' +
          ...
          if (
            dragsArr[dg].image != "no" &&
            (dragsArr[dg].text == "no" || dragsArr[dg].text == "")
          ) {
            htmlStmt +=
    ...
    htmlStmt +=
      ' <div class="drop_wrap d-flex align-items-center justify-content-center">';
    ...
    if (dropsArr.length > 0) {
      for (var dp = 0; dp < dropsArr.length; dp++) {
        htmlStmt +=
          '<div class="opt drop align-items-center" id="drop_' +
          currentQue +
          "_" +
          (dp + 1) +
          '">';
        ...
        if (
          ...
          if (dropsArr[dp].image != "no") {
            if (dropsArr[dp].audio == "no" || dropsArr[dp].audio == "") {
              ...
              htmlStmt +=
                '<div class="imgHolder audioTile" data-audio="' +
                dropsArr[dp].audio +
                '" data-onaudioplay="' +
                onImgAudioPlay +
                '">';
