...
function initiateActivityType(aActTyp, aActSubType) {
  ...
  } else if (aActTyp == "circle_adverb_underline_verb") {
    theActivity = new CircleAdverbUnderlineVerb(
      quePart,
      circle_adverb_underline_verb_data,
    );
  } else if (aActTyp == "colour_verbs_adverbs") {
    theActivity = new ColourVerbsAdverbs(quePart, colour_verbs_adverbs_data);
  } else if (aActTyp == "colour_picture_write_sentence") {
    theActivity = new ColourPictureWriteSentence(
      quePart,
