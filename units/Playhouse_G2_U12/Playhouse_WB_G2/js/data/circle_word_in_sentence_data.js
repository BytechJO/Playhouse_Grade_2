var stereo_data = {
    ...
    "playListData" : [
        {
          'audiourl': '../audios/page_62/PLAYHOUSE_2_WB_UNIT_12_TRACK_05_01.mp3',
        },
        {
          'url': '',
        },
...
var mcq_data = {     
    ...
    "subTitleTextRight"     : "",
    "subTitleIcons"         : [],
    "subTitleAudio"         : "../audios/page_62/under.mp3",
    ...
    "questions"             : [
        {
            "question"              : "<b>1</b> &nbsp; The man is not tall. He is([_])",
            "options"               : [["short","torch"]],          
            "answer"                : [1],
			"inputbox"				:"yes",
			"image"					: '',
        ...
        {
            "question"              : "<b>2</b> &nbsp; It is dark. He turns on his ([_])",
            "options"               : [["porch","torch"]],
            "answer"                : [2],
			"inputbox"				: "yes",
			"image"					: '',
        ...
        {
            "question"              : "<b>3</b> &nbsp; The children sat on the ([_])",
            "options"               : [["porch","short"]],          
            "answer"                : [1],
			"inputbox"				:"yes",
			"image"					: '',
