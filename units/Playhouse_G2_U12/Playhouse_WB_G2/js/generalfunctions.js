        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "circle_adverb_underline_verb":
              if (
                typeof circle_adverb_underline_verb_data !== "undefined" &&
                circle_adverb_underline_verb_data !== null
              ) {
                buildCircleAdverbUnderlineVerbBody(
                  circle_adverb_underline_verb_data,
                );
              }

              break;
            case "colour_verbs_adverbs":
              if (
                typeof colour_verbs_adverbs_data !== "undefined" &&
                colour_verbs_adverbs_data !== null
              ) {
                buildColourVerbsAdverbsBody(colour_verbs_adverbs_data);
              }

              break;
            case "colour_picture_write_sentence":
              if (
                typeof colour_picture_write_sentence_data !== "undefined" &&
                colour_picture_write_sentence_data !== null
              ) {
                buildColourPictureWriteSentenceBody(
                  colour_picture_write_sentence_data,
                );
              }
