var _data = {
  ...
  header: {
    ...
    audio: "./audios/page_88/UNIT_12_-_An_African_Safari.mp3",
    title: {
      text: "An African Safari",
  ...
  footer: {
    ...
    reviewbutton: {
      visible: "yes", // yes (or) no
      link: "./Playhouse_Review_G1_U1/views/fillin_text_in_sentences_2.html",
    },
    booksbutton: {
      workbook: {
        icon: "../images/icons/book-2.png",
        link: "../Playhouse_WB_G2/views/multiple_choice.html",
      },
      studentbook: {
