...
var Popups_data = {
  slides: [
    {
      listen: {
        ...
        titlesAudio: [
          "../audios/page_88/1_Listen_and_say.mp3",
        ...
        audio: [
          "../audios/page_88/1_gazelle.mp3",
          "../audios/page_88/2_gorilla.mp3",
          "../audios/page_88/3_lion.mp3",
          "../audios/page_88/4_cub.mp3",
          "../audios/page_88/5_panther.mp3",
          "../audios/page_88/6_baboon.mp3",
          "../audios/page_88/7_ostrich.mp3",
          "../audios/page_88/8_rhinocerous.mp3",
          "../audios/page_88/9_cheetah.mp3",
          "../audios/page_88/10_hippopotamus.mp3",
          "../audios/page_88/11_alligator.mp3",
          "../audios/page_88/12_flamingo.mp3",
        ],
      },
      listen2: {
  ...
  postions: [
    "left:13.50%; top:53.63%;",
    "left:18.75%; top:36.63%;",
    "left:27.67%; top:56.75%;",
    "left:33.00%; top:59.63%;", // 4
    "left:18.92%; top:74.50%;",
    "left:38.50%; top:48.00%;", // 6
    "left:58.83%; top:41.50%;",
    "left:42.33%; top:56.25%;",
    "left:64.00%; top:39.38%;",
    "left:72.17%; top:59.50%;",
    "left:41.00%; top:82.38%;",
    "left:70.75%; top:80.13%;",
  ],
  imagesAudio: [
    "../audios/page_88/1_gazelle.mp3",
    "../audios/page_88/2_gorilla.mp3",
