function buildFillInBody(aObj) {
  ...
  $(".activity_area")
    .off("input.autoNextLetter", ".text_input_area")
    .on("input.autoNextLetter", ".text_input_area", function () {
      var $currentInput = $(this);

      // يقبل حرفًا واحدًا فقط
      ...
      // عند كتابة الحرف ينتقل للـ input التالي داخل نفس السؤال
      if (value.length === 1) {
        var $question = $currentInput.closest(".img_fillin_gr");
