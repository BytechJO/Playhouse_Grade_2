...
var stereo_data = {
    ...
    "playListData" : [
        {
          'audiourl': '../audios/page_76/PLAYHOUSE_2_WB_UNIT_15_TRACK_03_01.mp3',
        },
        {
          'url': '',
        },
...
var mcq_tick_data = {    
    ...
    "subTitleTextLeft"      : "<span class='blue_text'>1</span> Look at each picture and ✓ the correct sentence. ",
    "subTitleTextRight"     : "",
    "subTitleIcons"         : [],
    ...
    "questions"             : [
        {
          ...
          "options"               : [
              ...
              {
                "text"          : "She wakes up at nine o’clock.",
                "image"         : "no",
                "audio"         : "no",
                "audioenable"   : "default", // correct (or) default
              },               
      ...
      },
      {
          ...
          "options"               : [
              {
                  "text"          : "He does his homework at one o’clock.",
                  "image"         : "no",
                  "audio"         : "no",
                  "audioenable"   : "default", // correct (or) default
                },
                {
                    "text"          : "He does his homework at three o’clock.",
                    "image"         : "no",
                    "audio"         : "no",
                    "audioenable"   : "default", // correct (or) default
                },               
        ...
        },  
        {
            ...
            "options"               : [
                {
                    "text"          : "She goes to the mall at five o’clock.",
                    "image"         : "no",
                    "audio"         : "no",
                    "audioenable"   : "default", // correct (or) default
                },
                {
                  "text"          : "She goes to the mall at six o’clock.",
                  "image"         : "no",
                  "audio"         : "no",
                  "audioenable"   : "default", // correct (or) default
                },               
