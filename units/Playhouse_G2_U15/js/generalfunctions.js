        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "writeaboutclock":
              if (
                typeof write_about_clock_data != undefined &&
                write_about_clock_data != null
              ) {
                buildWriteAboutYourselfClockBody(write_about_clock_data);
              }
              break;
            case "underline_circle":
              if (
                typeof underline_circle_data !== "undefined" &&
                underline_circle_data !== null
              ) {
                buildUnderlineCircleBody(underline_circle_data);
              }
              break;
          }
        } else {
