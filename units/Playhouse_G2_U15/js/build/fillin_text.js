	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		htmlStmt += '<div class="group_elm '+aObj.parentClassName+'">';
			...
			for (x = 0; x < numOfQuestions; x++) {
				...
				if (tmpObj.image != '' && tmpObj.imagePosition == "front") {
				  htmlStmt += '<div class="image_space"><img src="' + tmpObj.image + '" class="pulse"></div>';
				}
				...
				if(aObj.numbering != 'none'){
					...
					if (tmpObj.options_words != undefined && tmpObj.options_words != '') {
						...
						for(let y=0; y<tmpObj.options_words.length; y++){
							htmlStmt += '<div class="audioIcon txt-audioIcon off d-flex contant " data-audio="' + tmpObj.options_words_audios[y] + '" style="left:'+tmpObj.word_position_left[y]+';">';
					...
					if (tmpObj.image != '' && tmpObj.imagePosition == "back") {
						htmlStmt += '<div class="image_space"><img src="' + tmpObj.image + '" class="pulse"></div>';
					}
