...
function initiateActivityType(aActTyp, aActSubType) {
  ...
  } else if (aActTyp == "writeaboutclock") {
    theActivity = new WriteAboutYourselfClock(quePart, write_about_clock_data);
  } else if (aActTyp == "underline_circle") {
    theActivity = new UnderlineCircle(quePart, underline_circle_data);
