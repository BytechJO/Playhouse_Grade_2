...
function buildHeader(aObj) {
    ...
    if (typeof aObj != undefined && aObj != null) {
        ...
        // fStmt += "<div class='d-flex col-1 col-xs-1 col-md-1 flex-wrap justify-content-end'>";
        // fStmt += "<div class='homeBtn my-auto " + ((homeVisible == 'yes') ? 'd-block' : 'd-none') + "'>";
        // fStmt += "<a href='" + homeLink + "?u=" + aObj.unitno + "'>";
        // fStmt += "<img class='pt-1' src='" + _templatePath + _assetsPath + "home_btn.png' height='65px'>";
        // fStmt += '</a>';
        // fStmt += "</div>";
        // fStmt += "</div>";
...
function buildFooter(aObj) {
    ...
    if (typeof aObj.buttons != undefined && aObj.buttons != null && typeof aObj.filetoload != undefined && aObj.filetoload != null) {
        ...
        //     fStmt += "<a href=" + reviewLink + " class=''>";
        //     fStmt += "<img class='pt-1' src='" + _templatePath + _assetsPath + "book-2.png'>";
        //     fStmt += '</a>';
        //     fStmt += "</div>";
        // fStmt += "</div>";
        fStmt += "</div></div>";
