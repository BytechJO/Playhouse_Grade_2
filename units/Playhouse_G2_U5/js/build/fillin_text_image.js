	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		htmlStmt += '<div class="group_elm d-flex flex-wrap justify-content-center align-items-center mb-70">';
			...
			for (x = 0; x < numOfQuestions; x++) {
				...
				htmlStmt += '<div class="que img_fillin_gr background_audio d-flex flex-column" data-qno="' + (x + 1) + '">';
				...
				htmlStmt += '<div class="audioIcon textFront off contant audioQuestionTitle" data-audio="">';
