        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "lookandwritebodyparts":
              if (
                typeof look_and_write_body_parts_data !== "undefined" &&
                look_and_write_body_parts_data !== null
              ) {
                buildLookAndWriteBodyParts(look_and_write_body_parts_data);
              }
              break;
          }
        } else {
