        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "mcq":
              ...
              } else if (_fileSubType == "dinosaurs") {
                if (
                  typeof mcq_dinosaurs_data != undefined &&
                  mcq_dinosaurs_data != null
                ) {
                  buildListenDinosaursColourBoxesBody(mcq_dinosaurs_data);
                }
              } else if (_fileSubType == "inline_adjective") {
                if (
                  typeof mcq_inline_adjective_data != undefined &&
                  mcq_inline_adjective_data != null
                ) {
                  buildReadChooseAdjectiveBody(mcq_inline_adjective_data);
                }
              }
            ...
            case "linkedwriting":
              if (
                typeof linkedwriting_data != "undefined" &&
                linkedwriting_data != null
              ) {
                buildLinkedWritingBody(linkedwriting_data);
              }

              break;
            case "lookreadmatch":
              if (
                typeof look_read_match_data != "undefined" &&
                look_read_match_data != null
              ) {
                buildLookReadMatchBody(look_read_match_data);
              }

              break;
            case "clickcommaswrite":
              if (
                typeof click_commas_write_data != "undefined" &&
                click_commas_write_data != null
              ) {
                buildClickCommasWriteBody(click_commas_write_data);
              }
