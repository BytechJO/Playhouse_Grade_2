...
function initiateActivityType(aActTyp, aActSubType) {
  ...
  if (aActTyp == "fillin") {
    ...
    } else if (aActSubType == "tick") {
      theActivity = new MCQ(quePart, mcq_tick_data);
    } else if (aActSubType == "dinosaurs") {
      theActivity = new MCQ(quePart, mcq_dinosaurs_data);
    } else if (aActSubType == "inline_adjective") {
      theActivity = new MCQ(quePart, mcq_inline_adjective_data);
    }
  ...
  } else if (aActTyp == "linkedwriting") {
    theActivity = new LinkedWriting(quePart, linkedwriting_data);
  } else if (aActTyp == "lookreadmatch") {
    theActivity = new LookReadMatch(quePart, look_read_match_data);
  } else if (aActTyp == "clickcommaswrite") {
    theActivity = new ClickCommasWrite(quePart, click_commas_write_data);
