        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "clickcommasonly":
              if (
                typeof click_commas_only_data != "undefined" &&
                click_commas_only_data != null
              ) {
                buildClickCommasOnlyBody(click_commas_only_data);
              }

              break;
            case "write_sentences":
              if (
                typeof write_sentences_data != "undefined" &&
                write_sentences_data != null
              ) {
                buildWriteSentencesBody(write_sentences_data);
              }
              break;
          }
        } else {
