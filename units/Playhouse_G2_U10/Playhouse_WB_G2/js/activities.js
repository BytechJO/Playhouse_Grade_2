...
function initiateActivityType(aActTyp, aActSubType) {
  ...
  } else if (aActTyp == "clickcommasonly") {
    theActivity = new ClickCommasOnly(quePart, click_commas_only_data);
  } else if (aActTyp == "write_sentences") {
    theActivity = new WriteSentences(quePart, write_sentences_data);
